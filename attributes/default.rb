...
default['prometheus']['alertmanager']['version']                                          = '0.8.0'
...
# Default for testing purposes
default['prometheus']['alertmanager']['binary_url']                                       = "https://github.com/prometheus/alertmanager/releases/download/v#{default['prometheus']['alertmanager']['version']}/alertmanager-#{default['prometheus']['alertmanager']['version']}.linux-amd64.tar.gz"

# Checksum for pre-compiled binary
# Default for testing purposes
default['prometheus']['alertmanager']['checksum']                                         = 'b569ae0d31e5df59391124578bcf9b28316cf12adb4cc9d10f439fc3ab3422f1'
